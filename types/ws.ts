...
export interface WebSocketAlias extends WebSocket {} // eslint-disable-line @typescript-eslint/no-empty-interface
 ...
 */
export type VerifyClientCallbackSync<Request extends IncomingMessage = IncomingMessage> = (info: {
  origin: string;
  secure: boolean;
  req: Request;
}) => boolean;
...
> extends EventEmitter {
  ...
  on(
    event: "headers",
    cb: (this: Server<T>, headers: string[], request: InstanceType<U>) => void,
  ): this;
...
// WebSocket stream
export declare function createWebSocketStream(
  websocket: WebSocket,
